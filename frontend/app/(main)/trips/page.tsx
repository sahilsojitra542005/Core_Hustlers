    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <Button className="bg-[#c2843b] hover:bg-[#b4752c] text-white h-8 text-xs">
            <Plus className="mr-2 h-3 w-3" /> Create Trip
          </Button>
        </div>
        ...
        <div>
          <h3 className="text-xs font-semibold text-muted-foreground tracking-wider uppercase mb-4">MOCK DISPATCH FORM (PREVIEW)</h3>
      ...
      <div>
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <div className="text-sm text-muted-foreground border border-dashed border-border rounded-lg p-6 text-center">No active trips found.</div>
          ) : liveTrips.map((trip) => (
            <div key={trip._id} className="p-4 rounded-lg border border-border border-dashed bg-card/50">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="text-muted-foreground font-mono text-xs mb-1">{trip.tripId}</div>
